...
const PurchaseOrders = () => {
  ...
  const updateStatus = async (
    ...
    try {
      await api.put(
        `/purchase-orders/${order._id}/status`,
        {
          status,
        }
      );
      ...
      message.success(
        `Purchase order marked as ${status}.`
      );
  ...
  const handleReceive = async (
    ...
    try {
      ...
      await api.post(
        `/purchase-orders/${selectedOrder._id}/receive`,
        {
          items,
        }
      );
