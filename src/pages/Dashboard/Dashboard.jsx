        ...
        <div className="branch-picker">
          ...
          {branchOpen && (
            <div className="branch-picker-menu">
              ...
              <div className="branch-picker-title">
                SELECT BRANCH
              </div>
        ...
        <Card className="sales-overview-card">
          ...
          <div className="sales-overview-summary">
            ...
            <div>
              ...
              <strong>
                ₱
                {periodSalesTotal.toLocaleString(
                  undefined,
                  {
                    minimumFractionDigits: 2,
                  }
              ...
              {smartRecommendations.map(
                (item) => (
                  ...
                  >
                    ...
                    <div
                      className={`smart-risk ${getRiskClass(
                        item.risk
                      )}`}
                    >
