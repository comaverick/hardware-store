...
disabled; incompatible frames are still rejected. `algorithmVersion: 16`
...
Algorithm 16 has no single-view or registered-composite fallback. Room captures below
