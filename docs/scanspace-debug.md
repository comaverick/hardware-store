...
disabled; incompatible frames are still rejected. `algorithmVersion: 15`
...
Algorithm 15 has no single-view or registered-composite fallback. Room captures below
...
finer fusion volume and does not require a complete room footprint.
